...
<div style="display: flex; gap: 10px;">
   <a href="https://www.linkedin.com/in/mathewsbuzetti" style="text-decoration: none;">
       <div style="background-color: #0A66C2; color: white; padding: 5px 10px; border-radius: 4px; font-weight: bold; text-transform: uppercase;">LINKEDIN</div>
   </a>
   <div style="background-color: #0089D6; color: white; padding: 5px 10px; border-radius: 4px; font-weight: bold; text-transform: uppercase;">AZURE</div>
   <div style="background-color: #FF6F00; color: white; padding: 5px 10px; border-radius: 4px; font-weight: bold; text-transform: uppercase;">EXPERT</div>
   <div style="background-color: #FF4500; color: white; padding: 5px 10px; border-radius: 4px; font-weight: bold; text-transform: uppercase;">SOLUTIONS ARCHITECT</div>
</div>
