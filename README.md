...
const BadgeProfile = () => {
  return (
    <div className="flex items-center gap-3 mb-4">
      <a 
        href="https://www.linkedin.com/in/mathewsbuzetti" 
      ...
      <a 
        href="https://www.credly.com/badges/microsoft-certified-azure-solutions-architect-expert" 
        className="inline-block no-underline"
      >
        <img 
      ...
      >
        <img 
          src="https://img.shields.io/badge/Expert-FF6F00?style=for-the-badge&logo=verified&logoColor=white" 
          alt="Expert" 
          className="block border-none"
        />
      </a>
